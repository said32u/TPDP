...
public class Main {
    public static void main(String[] args) {
        ...
        Visiteur v = new VisitNbPhotos();
        Article a = new Article(1,"azertezrgere","azerty","Coucou");
        Visiteur vTexte = new VisitTextes("azerty");

        System.out.println(a.accept(vTexte));
